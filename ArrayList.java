...
public class ArrayList implements List {
    ...
    /*
     * Constructs an ArrayList object with the specified maximum size for a list
    ...
    /*
     * Constructs an ArrayList object containing the items in the specified array,
     * and with a max size that is twice the size of that array (to allow room for
     * growth).
     */
     ...
     * Returns false if the list is full, and true otherwise.
     */
    ...
    // This is the removeAll method that removes all occurences of an item
    public boolean removeAll(Object item) {
        // First set a counter that is equal to 0
        int counter = 0;
      ...
      //  changing the length to something relevant
        length = counter;
        return true;
      }
    ...
    public static void main(String[] args) {
        Object [] list = { 1, 2, 3, 3, 4, 4, 5, 6 };
        // Object num = 2;
        ArrayList arrList = new ArrayList(list);
        
      
        System.out.println(arrList.removeAll(3));
        System.out.println(arrList.addItem(3,3));
